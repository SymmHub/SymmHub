...
import {cMul} from './ComplexArithmetic.js';
...
export class PatternTextures {
    ...
    ///////////
    //
    //  imageGluedToOriginQ is new; the image itself always has its center at 00 in math coords.
    //  center now becomes the center of a transformed copy of the image, which we
    // render the outline of. Correspondingly, the center and angle are reset by the 
    // orbifoldgeometrization.js, always keeping the center inside of the copy of the 
    // fundamental domain that includes the origin. 
    // if !imageGluedToOriginQ, it's the same as before. 
    // 
    ///////////
  ...
  */
  ...
  initGUI(options){
    ...
    ///////////
    // A more radical change will be to put centers 
    // and angles inside of the texture manager objects.
    // That seems where they belong -- so TBD: hook up these 
    // controllers to keys inside of textureManager.
