...
import { reidemeisterSchreier } from './reidemeister.js';
...
export {
  ...
  ellipticElements,
  presentationOf,
  // a presentation of a subgroup from its coset table
...
export default {
  ...
  subgroupStructure, abelianInvariants, ellipticElements, presentationOf,
  triangleGeometry, reidemeisterSchreier,
};
