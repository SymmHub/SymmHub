...
void main () {
    ...
    if(uGridEnabled) {
        ...
        //float uu = log(length(pnt));
        //float vv = atan(pnt.y, pnt.x)/PI;
        //float uu = pnt.x;
        //float vv = pnt.y;
        //float gridDensX = isolines_multi(uu, uIsoOffset, uGridStep.x, uIsoThickness, uIsoLevels);
        //float gridDensY = isolines_multi(vv, uIsoOffset, uGridStep.y, uIsoThickness, uIsoLevels);
