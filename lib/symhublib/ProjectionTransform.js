...
export function ProjectionTransform(options){
    ...
    let mFixedPointsTransform = new FixedPointsTransform({groupMaker: mGroupMaker});
    ...
    function makeBandMapParams(){
        ...
        let bmp = mConfig.bandMap;
        let onc = onParamChanged;
        return ParamGroup({
            name: 'band',
            params: {
                enabled: ParamBool({obj:bmp,key: 'enabled',onChange: onc}),
            }
        });
    }
    ...
    //
    //
    function makeSphereMapParams(){
        
        let obj = mConfig.sphereMap;
        let onc = onParamChanged;
        return ParamGroup({
            name: 'sphere',
            params: {
    ...
    function getUniforms(un){
                
        un.u_bandEnabled = mConfig.bandMap.enabled;
