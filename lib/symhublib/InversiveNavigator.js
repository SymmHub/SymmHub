...
export class InversiveNavigator {
    ...
    init(options) {
        ...
        this.mProjection = ProjectionTransform({onChange:this.onProjectionChanged.bind(this)});
    ...
    makeParams() {
        ...
        let p = {
            ...
            projection: ParamObj({obj: this.mProjection, name: 'conformal transforms'}),
            inversive:  this.makeInversiveParams(),
            spherical:  this.makeSphericalParams(), 
            euclidean:  this.makeEuclideanParams(),
            
            //centerX:    ParamFloat({obj:par,  key:'centerX', name: 'x-center', onChange:occ}),
            //centerY:    ParamFloat({obj:par,  key:'centerY', name: 'y-center', onChange:occ}),
            //zoom:       ParamFloat({obj:par,  key:'zoom',                   onChange:ozc}),
            //itrans:     ParamInvTrans({obj: par, key: 'itrans', name: 'inv trans', onChange:otc}),
    ...
    setParamsMap(pmap) {
        ...
        setParamValues(this.mParams, pmap);
    ...
    getUniforms(un) {
        ...
        ct.onCanvasResize();
        //trans.initTransform();
        if (ct.getUniforms) un = ct.getUniforms(un);
        ...
        un = this.mProjection.getUniforms(un);
