...
export class InversiveNavigator {
    ...
    onMouseWheel(evt) {
        ...
        let increment = evt.deltaY;
        if (evt.ctrlKey) {
            
            this.onWheelHyperbolic(spnt, increment);
            
        } else if (evt.shiftKey) {
            
            this.onWheelElliptic(spnt, increment);
    ...
    //
    onWheelHyperbolic(spnt, increment) {

        var delta = Math.sign(increment);
    ...
    //
    onWheelElliptic(spnt, increment) {
    ...
    //
    //
    onWheelEuclidean(spnt, increment) {

        var delta =  Math.sign(increment);

        //console.log('mouseWheel X:',evt.deltaX," Y:", evt.deltaY, "Z:", evt.deltaZ, " mode:", evt.deltaMode, " delta:", evt.wheelDelta);
        
        let inc = this.getIncrement(delta, this.zoomDelta);

        let zoomFactor = Math.exp(-delta*inc);
