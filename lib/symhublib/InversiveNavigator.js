...
export class InversiveNavigator {
    ...
    init(options) {
        ...
        console.log(`${MYNAME}.init() options: `, options, 'config: ', this.config);
    ...
    onAnimationChanged(){
        ...
        if(this.config.options.animation){
           ...
           this.informListener(); // start animation callback  
            ...
            this.animatedPointer = null; // stop animation callback 
    ...
    onMouseDown(evt) {
        ...
        if(this.config.options.animation){ 
            ...
            if(DEBUG) {
                ...
                this.pointerData.log.push({log:'onMouseDown()', evt: evt});
            }
    ...
    onMouseWheel(evt) {
        ...
        //if(DEBUG) console.log(`${MYNAME}.onMousewWheel()`, evt);
        
    
        //if(false) {  // disable 
        
        let wheelIncrement = evt.deltaY;
        ...
        if(this.config.options.animation) {           
            ...
            ap.eventData = evt;
            if(DEBUG) {
                this.pointerData.log.push({log:'onMouseWheel()', evt: evt, timestamp: this.timeStamp});
    ...
    onPointerWheel(increment, evt){
        ...
        let spnt = getCanvasPnt(evt);
        if(DEBUG) {
            //console.log('onPointerWheel: ', spnt, increment, evt);
        }
        if (evt.ctrlKey) {
    ...
    onWheelEuclidean(spnt, wheelIncrement) {
        ...
        //if(DEBUG) console.log('increment: ', increment);
        let zoomFactor = Math.exp(-(wheelIncrement*WHEEL_FACTOR_EUC));
        //if(DEBUG) console.log('zoomFactor: ', zoomFactor);
