...
//
function VisualizationLayerFactory(getGLCtx, getOnChange, getChildren, getInitPar) {
    ...
    return ObjectFactory({
        ...
        infoArray: [
            ...
            { name: 'OverlayIsolines',   label: 'isolines',    creator: make(OverlayIsolines,   { enabled: true }, 'isolines'  ) },
            { name: 'OverlayWorldGrid',  label: 'world grid',  creator: make(OverlayWorldGrid,  { enabled: true }, 'worldGrid' ) },
            { name: 'OverlayScreenGrid', label: 'screen grid', creator: make(OverlayScreenGrid, { enabled: true }, 'screenGrid') },
        ],
    });
}
