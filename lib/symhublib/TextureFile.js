...
export class TextureFile {
    ...
    _setParamsMap_deprecated(pm) {
        ...
        if (isDefined(pm.texInfo)) {
            ...
            if (this.texControls.interpolation) this.folder.remove(this.texControls.interpolation);
            ...
            this.texControls.interpolation = this.folder.add(this.texParams, 'interpolation', InterpolationNames).name('interpolation').onChange(onTexChanged);
        ...
        if (isDefined(pm.interpolation))
            this.texControls.interpolation.setValue(pm.interpolation);
    ...
    _initGUI_deprecated(folder) {
        ...
        this.texControls.interpolation = folder.add(this.texParams, 'interpolation', InterpolationNames).name('interpolation').onChange(onTexChanged);
        this.texControls.texSize = this.folder.add(this.texParams, 'texSize').name('size').onChange(onTexChanged);
