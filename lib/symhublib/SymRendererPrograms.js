...
function createProgramsInstance(){
    ...
    const pb = programBuilder(gPrograms, true);
    let mGL = null;
    ...
    function init(gl){
        ...
        mGL = gl;
        // Trigger compileAll — programBuilder compiles every program on the first call.
        pb.getProgram(gl, Object.keys(gPrograms)[0]);
    }
