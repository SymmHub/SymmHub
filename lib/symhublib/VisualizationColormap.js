...
const VisComponents = ['u','v', 'mod(uv)', 'arg(uv)'];
//
...
function VisualizationColormap(par={}){
    ...
    function makeParams(cf) {
        ...
        return {
            ...
            visComponent: ParamChoice({obj: cf,key: 'visComponent', choice: VisComponents, onChange: oc}),
    ...
    function render(par){
       ...
       //if(DEBUG) console.log(`${MYNAME}.render()`, par);
        ...
        let colormapUni = { 
            ...
            uVisualComponent: VisComponents.indexOf(cmCfg.visComponent),
