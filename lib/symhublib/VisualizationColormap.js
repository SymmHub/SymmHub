...
function VisualizationColormap(par={}){
    ...
    let mConfig = {
        enabled: true,
        opacity: 1,
        visComponent: VisComponentNames[0],
    ...
    function makeParams(cf) {
        ...
        return {
            ...
            visComponent: ParamChoice({obj: cf,key: 'visComponent', choice: VisComponentNames, onChange: oc}),
    ...
    function render(par){
       ...
       //if(DEBUG) console.log(`${MYNAME}.render()`, par);
        ...
        let colormapUni = { 
            ...
            uVisualComponent: VisComponentNames.indexOf(cmCfg.visComponent),
