...
function SymRenderer(options) {
    ...
    mNavigator.init({canvas: mCanvas.overlay, onChanged: onTransformChanged, canvasTransform: mCanvasTransform});
    ...
    */
    ...
    //  not used, moved to mNavigator.getUniforms
    //
    ...
    function setDocumentData(jsonObj){
        ...
        setParamValues(mParams, jsonObj.params);
