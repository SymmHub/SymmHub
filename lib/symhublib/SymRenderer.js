...
function SymRenderer(options) {
    ...
    function setDocumentData(jsonObj){
        ...
        if(DEBUG)console.log(`${MYNAME}.setDocumentData()`, JSON.stringify(jsonObj, null, 2));
        SymRendererUpgradeData(jsonObj, {groupMakerFactory: mGroupMakerFactory});
        setParamValues(mParams, jsonObj.params, true);
        if(DEBUG)console.log(`${MYNAME}.setDocumentData() upgraded obj: `, JSON.stringify(jsonObj, null, 2));        
