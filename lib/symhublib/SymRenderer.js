...
function SymRenderer(options) {
    ...
    function startApplication() {
        ...
        mDocManager = createDocumentManager({
            appInfo:          mAppInfo,
            params:           mParams,
            useBinaryFiles:   mUseBinaryFiles,
    ...
    function makeFilesParams() {
        ...
        return ParamGroup({
            ...
            params: {
                ...
                read:           ParamFunc({func: () => mDocManager.onOpenDocument(), name: 'Open...'}),
                selectDocFolder:ParamFunc({func: () => mDocManager.onSelectFolder(), name: 'Select Doc Folder...'}),
