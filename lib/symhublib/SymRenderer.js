...
function SymRenderer(options) {
    ...
    function exportImageWrapper(chosenName, folderHandle, exportWidth, exportHeight) {
        const rendererObj = {
            ...
            saveImageTo: (canvas, fh, name, json) => mImageSaver.saveImageTo(canvas, fh, name, json),
        ...
        exportImage(chosenName, folderHandle, exportWidth, exportHeight, rendererObj);
    }
