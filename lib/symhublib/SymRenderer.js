...
function SymRenderer(options) {
    ...
    let mGLOverlayRenderer = GLOverlayRenderer();
    mGLOverlayRenderer.setOptions({onChanged: scheduleRepaint});
    ...
    function makeVisParams() {
        ...
        return ParamGroup({
            ...
            params: {
                ...
                overlayVis: mGLOverlayRenderer.getParams(),
    ...
    function renderGLOverlay() {
        
        let overConf = mGLOverlayRenderer.getConfig();
        
        let iconf = overConf.isolines;
    ...
    function onFragLoaded() {
        ...
        if (DEBUG)
            console.log(`${MYNAME}.onFragLoaded() ${getTime()-loadStartTime} ms`);
        ...
        if (DEBUG)
            console.log(`${MYNAME}.makeProgramsCached() ready ${getTime()-t0} ms`);
