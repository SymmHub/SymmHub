...
const USE_SymRendererVisualization = true;
...
function SymRenderer(options) {
    ...
    //
    let mGLOverlayRenderer = VisualizationOverlay();
    mGLOverlayRenderer.init({onChanged: scheduleRepaint});
    ...
    function makeMiscParams() {
        ...
        return ParamGroup({
            name: 'misc',
            params: {
                //renderStyle:ParamChoice({obj: visConf,key: 'renderStyle', name: 'rendering', choice: RENDER_STYLES,
                //    onChange: onChange,
                //}),
    ...
    function renderGLCanvas() {
        ...
        //enableBlending();
        if(USE_SymRendererVisualization){
            ...
            switch (mConfig.misc.renderStyle) {
            default:
            case VIS_COLORMAP:
                renderVisColormap();
                break;
