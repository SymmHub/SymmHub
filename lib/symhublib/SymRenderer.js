...
function SymRenderer(options) {
    ...
    function drawSimColormap() {
        ...
        if(mConfig.visualization.options.useMipmap){
            drawSimColormapMipmap();
        } else {
            drawSimColormapBase();
    ...
    //
    //  basic colormap rendering
    //
    function drawSimColormapBase() {
    ...
    function drawSimColormapMipmap() {
        ...
        //let backColor = hexToPremult(mConfig.display.backgroundColor);
