...
export function VisualizationOverlay(par={}){
    ...
    // Prepend the editable 'name' field so it appears first in the UI folder.
    let mParams = { name: ParamString({ obj: mIdRef, key: 'id', name: 'name', onChange: () => { if (mOnIdChange) mOnIdChange(); } }), ...overlayParams };
    let mOnChange = null;
    let mPrograms = null;
    let mGLCtx = null;
