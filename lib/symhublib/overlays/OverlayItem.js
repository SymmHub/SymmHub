/*
  ...
  A kind is described by a spec:
    ...
    symmetry     true for the kinds drawn from group data: the item gets a
                 ...
                 see OverlaySymmetry.js) and its own group data when a subgroup is used
...
export function makeOverlayItem(spec, par = {}) {
    ...
    function render(par) {
        ...
        if (mSymmetry) prog.setUniforms(mSymmetry.getUniforms(par));   // own group data for a subgroup
