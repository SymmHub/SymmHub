...
function getFrizeGroup(type, a){
    ...
    switch(type){
        ...
        case _22OO:
            return new Group({s:[s0, s1, s2a], t:[[s0, s2], [s1, s2], [s2, s1]]}); 
        case _2SOO:
            return new Group({s:[s0, s1, s2a], t:[[s0, s2], [s1], [s2a]]}); 
        case OOS:
            return new Group({s:[s0, s1, s2a], t:[[s0], [s1, s2], [s2, s1]]}); 
        case SOOOO:
            return new Group({s:[s1, s2]}); 
        case OOX:
            return new Group({s:[s1, s2a],t:[[s1,s2,s0],[s2, s1, s0]]});         
        case OOOO:
            return new Group({s:[s1, s2a],t:[[s1,s2],[s2, s1]]});                 
