...
/*
  ...
  class keys.  The catalogue manifests of 2026-09-05 sort by the key of the
  representative instead (subgroupKey); makeSubgroupNamer({classInvariant:
  false}) reproduces them exactly, tests/subgroups/catalog_names.mjs shows
