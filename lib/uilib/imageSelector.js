...
function createImageSelector(param = {}){
    ...
    function addImageItemFromTmb(tmb, userData){
            
        if(DEBUG)console.log('addImageItemFromTmb(): ', tmb.substring(0, 30), userData);  
        let item = createImageItem({tmb: tmb, onClick:onImageClick, userData: userData});        
    ...
    function addImageItemFromURL(imgUrl, userData){
            
        if(DEBUG)console.log(`addImageItemfromURL(): ${imgUrl}`);          
        //if(DEBUG)console.log(`    userData`, userData);          
        let item = createImageItem({url: imgUrl, onClick:onImageClick, userData: userData});        
        mainDiv.appendChild(item.elem);
    ...
    function addImageItemFromFile(file, data){
        if(DEBUG)console.log(`addImageItemfromFile(): ${file.name}`);          
        let item = createImageItem({file:file, onClick:onImageClick, userData: data, tmbSize: tmbSize});        
        mainDiv.appendChild(item.elem);
    ...
    function addItems(imageItems){
        ...
        if(DEBUG)console.log('ImageSelector.addItems()', imageItems);
