...
//
//    params: 
//    params.dragFriction  friction coefficient while dragging the mouse is   
//    params.freeFriction  friction coefficient during free motion  
...
function AnimatedPointer(params){
  ...
  function setParams(params){
    ...
    if(isDefined(params.freeFrictionFactor)){
      freeFriction = params.freeFrictionFactor;
    }
  ...
  function performSimulation(timeNow){
    ...
    while(t < deltaT){
      ...
      let forceX = -friction * speedX;
      let forceY = -friction * speedY;
