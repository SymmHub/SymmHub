...
export function createFolderPickerDialog(options = {}) {
    ...
    function renderFolderNode(dirHandle, pathStr, isRoot = false) {
        ...
        // Toggle arrow (consistent with TreeView)
        ...
        async function populateChildren() {
            ...
            if (subList.children.length === 0) {
                arrow.textContent = '';
                arrow.classList.remove('folder-arrow-right');
                arrow.style.cursor = 'default';
            }
        }

        // Toggle expansion handler (consistent with TreeView)
        async function toggleExpand(expand) {
            ...
            if (shouldExpand) {
                ...
                arrow.classList.remove('folder-arrow-down');
