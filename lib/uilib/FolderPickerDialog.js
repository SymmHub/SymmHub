...
export function createFolderPickerDialog(options = {}) {
    ...
    function renderFolderNode(dirHandle, pathStr, isRoot = false) {
        ...
        arrow.style.cssText = 'width:16px; height:16px; display:inline-flex; align-items:center; justify-content:center; font-size:0.8em; color:#666; cursor:pointer;';
        arrow.textContent = '\u25B8'; // ▶
        ...
        nameLabel.style.cssText = 'font-weight: 500;';
