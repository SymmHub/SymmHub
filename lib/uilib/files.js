...
// typeof guard keeps the module importable outside of a browser (node scripts)
const hasWindow = (typeof window !== 'undefined');

if(DEBUG && hasWindow)console.log('window.showOpenFilePicker:',window.showOpenFilePicker);


const supportsFileSystemAccess = hasWindow && "showOpenFilePicker" in window &&
    (() => {
        try {
