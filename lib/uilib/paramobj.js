...
function injectListButtons(paramObj, { onMoveUp, onMoveDown, onAdd, onRemove }) {
    ...
    [
        { lbl: '↑', tip: 'Move up',   act: onMoveUp   },
        { lbl: '↓', tip: 'Move down', act: onMoveDown },
        onAdd && { lbl: '+', tip: 'Add after', act: onAdd },
        { lbl: '✕', tip: 'Remove',    act: onRemove  },
    ].filter(Boolean).forEach(({ lbl, tip, act }) => {
...
function ParamObjArray(arg) {
    ...
    function removeChildAt(i) {
        ...
        renameAll();  // reindex remaining folders
    }
