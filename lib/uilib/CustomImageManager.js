...
// (globalThis keeps the module importable outside of a browser - node scripts)
const gGlobal = (typeof window !== 'undefined') ? window : globalThis;
if (!gGlobal.__symCustomImageCache) {
    gGlobal.__symCustomImageCache = {
        blobUrls: new Map(),
        decodedImages: new Map(),
        loadingImages: new Map()
    };
}
const gImageCache = gGlobal.__symCustomImageCache;
