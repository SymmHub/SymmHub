...
{
    float a = 0.2;
    p += a*cos( 1.5*p.yx + 0.03*1.0*time + vec2(0.1,1.1) );
    p += a*cos( 2.4*p.yx + 0.03*1.6*time + vec2(4.5,2.6) );
    p += a*cos( 3.3*p.yx + 0.03*1.2*time + vec2(3.2,3.4) );
    p += a*cos( 4.2*p.yx + 0.03*1.7*time + vec2(1.8,5.2) );
    p += a*cos( 9.1*p.yx + 0.03*1.1*time + vec2(6.3,3.9) );
...
void main(){
  ...
  outValue = deform(10.*vUv, uTime*0.02);
