# klm_groups.g
# Functions to construct KLM and SKLM triangle groups and process their subgroups.
...
#
# Function to generate subgroups for a single KLM or SKLM group and write to file
#
...
#
# Function to generate subgroups for a single KLM group and write it to sub/klm/sub_KLM.json
#
process_klm_group := function(K, L, M, maxIndex, maxSubgroups)
  ...
  process_group(G, "sub/klm/", name, maxIndex, maxSubgroups);
end;

#
# Function to iterate over all KLM groups in the range [2..maxOrder]
# and write results into files sub/klm/sub_KLM.json
#
