...
const int USEALPHAHEIGHT = 1; // do this by hand. 
// We really don't need to continue to debug this.
...
vec4 getColor(vec2 p){
    ...
    if( true ){
        ...
        if(u_drawLines == 1){
            overlay(color,iGetWalledFundDomainOutline(p3, u_domainData,u_domainCount, u_genCount, u_lineColor,u_lineWidth*pixelSize, pixelSize,0.));
        }
